            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xm-12">
                    ...
                    <div class="brocher-img">
                        ...
                        <a class="brocher-link" href="#">Download our Service <br>Brochure</a>
                    </div>
                </div>
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xm-12">
                    ...
                    <div class="section-video" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/service/video.jpg')">
                        <a class="popup-youtube" href="https://www.youtube-nocookie.com/embed/0OzbYNTTHPg?start=5"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/video/video-icon.png" alt="" class="youtube-click"></a>
                    </div>
